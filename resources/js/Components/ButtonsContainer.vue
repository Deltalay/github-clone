<template>
    ...
    <PrimaryButton class="h-7 text-xs border border-zinc-700 flex gap-1.5" @click.prevent="handlePin">

        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24">
            <path fill="#9198a1" fill-rule="evenodd"
    ...
    <ButtonWithDropdown @click.prevent="handleStar">
        <div class="flex gap-1.5 h-full py-1 items-center">
            <svg v-if="!starStatus" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24"
                fill="yellow">
                <path fill="#9198a1"
            ...
            <span class="bg-[#2f3742] p-[7px] h-full flex items-center rounded-full" ref="starAmount">
...
const handlePin = async () => {
    ...
    togglePinText();
    const response = await fetch(`/${props.info.user_name}/${props.info.id}/pin/`, {
        method: "PATCH",
